...
2. Analys sequentially don't stop, the current issues if any to understand the status of the project 
3. Analys t sequentially don't stop, the project code looking for dead code, duplication, bad practice, inconsistency, security issues, hacks, static methods, god classes, all possible code smells 
